...
impl SQLiteDatabase {
    pub fn get_lists(&self) -> Vec<models::List> {
        let mut stmt = self
            .conn
    ...
    pub fn get_current_list(&self) -> Option<String> {
    ...
    pub fn set_current_list(&self, list: &String) {
        self.conn
            .execute(
    ...
    pub fn create_list(&self, title: &String, description: &String) {
        self.conn
            .execute(
    ...
    pub fn update_list(&self, list: &models::List) {
        self.conn
            .execute(
    ...
    pub fn delete_list(&self, list: &models::List) {
        self.conn
            .execute("DELETE FROM lists WHERE id = ?1", params![list.id])
            .expect("Failed to delete list");
    }

    pub fn find_list(&self, title_or_id: &String) -> Option<models::List> {
    ...
    pub fn find_list_by_title(&self, title: &String) -> Option<models::List> {
        let result = self.conn.query_row(
    ...
    pub fn find_list_by_id(&self, id: &String) -> Option<models::List> {
        let result = self.conn.query_row(
    ...
    pub fn get_items(&self, list_id: &String) -> Vec<models::Item> {
        let mut stmt = self
            .conn
    ...
    pub fn get_item(&self, list_id: &String, item_id: &String) -> Option<models::Item> {
        let result = self.conn.query_row(
    ...
    pub fn create_item(&self, list_id: &String, title: &String, description: &String) {
        self.conn
            .execute(
    ...
    pub fn update_item(&self, list_id: &String, item: &models::Item) {
        self.conn
                .execute(
    ...
    pub fn delete_item(&self, list_id: &String, item: &models::Item) {
        self.conn
            .execute(
